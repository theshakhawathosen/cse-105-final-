...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .glow-blue {
            background: rgba(61, 127, 255, 0.13);
            width: 700px;
            height: 600px;
            top: -120px;
            left: -100px;
        ...
        .chip-green {
            background: rgba(41, 214, 142, 0.15);
            color: #29d68e;
        }
...
<body>
    ...
    <nav class="navbar">
        <div class="max-w-7xl mx-auto px-5 py-3 flex items-center justify-between">
            ...
            <a href="#" class="flex items-center gap-2.5 no-underline">
                <div class="w-8 h-8 rounded-xl bg-accent flex items-center justify-center text-white text-sm font-bold"
                    style="box-shadow:0 4px 16px rgba(61,127,255,0.4);">
            ...
            <div class="hidden md:flex items-center gap-2.5">
                @auth
                    @if (Auth::user()->role == 'admin')
                        <a href="{{ route('admin.dashboard') }}" class="btn-ghost">Admin Dashboard</a>
                    @else
                        <a href="{{ route('student.dashboard') }}" class="btn-ghost">Student Dashboard</a>
                    @endif
                @else
                    <a href="{{ route('login') }}" class="btn-ghost">Login</a>
                    <a href="{{ route('login') }}" class="btn-primary">Get Started <i
                            class="fas fa-arrow-right ml-1 text-xs"></i></a>
                @endauth
            </div>

            <!-- Mobile Hamburger -->
            <button class="md:hidden text-textSecondary hover:text-textPrimary transition-colors"
        ...
        <div class="mobile-menu md:hidden" id="mobile-menu">
            <div class="px-5 py-4 flex flex-col gap-3">
                ...
                <a href="#features" class="nav-link text-sm py-2 border-b border-border"
                    onclick="toggleMobile()">Features</a>
                <a href="#preview" class="nav-link text-sm py-2 border-b border-border"
                    onclick="toggleMobile()">Dashboard</a>
                <a href="#about" class="nav-link text-sm py-2 border-b border-border"
    ...
    <section id="home" class="relative min-h-screen flex items-center pt-20 grid-bg overflow-hidden">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-14 lg:gap-10">
                ...
                <div class="flex-1 text-center lg:text-left fade-up" style="animation-delay:0s;">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-5">
                        Your Complete<br>
                        <span
                            style="background:linear-gradient(90deg,#3d7fff,#a78bfa,#22d3ee);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">
                            Batch Solution
                        </span><br>
                        Platform
                    </h1>
                    ...
                    <p class="text-textSecondary text-base md:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 mb-8">
                        Access notices, assignments, lab reports, routines, resources and everything your batch needs —
                        all organized in one beautiful place.
                    </p>

                    <!-- Stats row -->
                    <div class="flex flex-wrap gap-4 justify-center lg:justify-start mb-8">
                        <div class="stat-badge"><i class="fas fa-users text-accent text-xs"></i><span
                                class="text-textPrimary text-xs font-semibold">150+ Students</span></div>
                        <div class="stat-badge"><i class="fas fa-book-open text-green text-xs"></i><span
                                class="text-textPrimary text-xs font-semibold">8 Courses</span></div>
                        <div class="stat-badge"><i class="fas fa-star text-amber text-xs"></i><span
                                class="text-textPrimary text-xs font-semibold">4.9 Rated</span></div>
                    </div>
                ...
                <div class="flex-1 w-full max-w-lg lg:max-w-none float-anim">
                    <div class="mock-screen" style="max-height:440px;overflow:hidden;">
                        ...
                        <div class="mock-topbar">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="relative">
                                    <div
                                        class="w-7 h-7 rounded-lg bg-input flex items-center justify-center text-textSecondary text-xs">
                                        <i class="fas fa-bell"></i>
                                    </div>
                                    <div class="notif-dot"></div>
                                </div>
                                <div
                                    class="w-7 h-7 rounded-lg bg-accent flex items-center justify-center text-white text-[10px] font-bold">
                                    R</div>
                            </div>
                        </div>
                        ...
                        <div class="flex" style="height:390px;">
                            ...
                            <div class="mock-sidebar w-36 p-3 flex-shrink-0 hidden sm:block">
                                <div class="text-muted text-[9px] font-semibold uppercase tracking-wider mb-2 px-2">
                                    Menu</div>
                                <div class="sidebar-item active"><i
                                        class="fas fa-th-large text-[10px]"></i><span>Dashboard</span></div>
                                <div class="sidebar-item"><i
                                        class="fas fa-bullhorn text-[10px]"></i><span>Notices</span></div>
                                <div class="sidebar-item"><i
                                        class="fas fa-tasks text-[10px]"></i><span>Assignments</span></div>
                                <div class="sidebar-item"><i class="fas fa-flask text-[10px]"></i><span>Lab
                                        Reports</span></div>
                                <div class="sidebar-item"><i
                                        class="fas fa-calendar text-[10px]"></i><span>Routine</span></div>
                                <div class="sidebar-item"><i class="fas fa-poll text-[10px]"></i><span>Polls</span>
                                </div>
                                <div class="sidebar-item"><i
                                        class="fas fa-book text-[10px]"></i><span>Resources</span></div>
                                <div class="sidebar-item"><i
                                        class="fas fa-chalkboard-teacher text-[10px]"></i><span>Teachers</span></div>
                                <div class="mt-3 pt-3 border-t border-border">
                                    <div
                                        class="text-muted text-[9px] font-semibold uppercase tracking-wider mb-2 px-2">
                                        Account</div>
                                    <div class="sidebar-item"><i
                                            class="fas fa-user text-[10px]"></i><span>Profile</span></div>
                                    <div class="sidebar-item"><i
                                            class="fas fa-cog text-[10px]"></i><span>Settings</span></div>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 p-3 overflow-hidden bg-bg" style="font-size:0.65rem;">
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    <div>
                                        <div class="text-textPrimary font-semibold text-xs">Good morning, Rahim 👋
                                        </div>
                                        <div class="text-textSecondary" style="font-size:0.6rem;">CSE-105 · Roll:
                                            2024331008</div>
                                    </div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div class="bg-card border border-border rounded-xl p-2.5">
                                        <div class="flex items-center justify-between mb-2">
                                            <span class="text-textPrimary font-semibold" style="font-size:0.65rem;"><i
                                                    class="fas fa-bullhorn text-accent mr-1"></i>Latest Notices</span>
                                        ...
                                        <div class="space-y-1.5">
                                            <div class="bg-input rounded-lg p-1.5">
                                                <div class="text-textPrimary"
                                                    style="font-size:0.6rem;font-weight:500;">Midterm Schedule Released
                                                </div>
                                                <div class="text-muted" style="font-size:0.55rem;">2 hours ago ·
                                                    Academic</div>
                                            </div>
                                            <div class="bg-input rounded-lg p-1.5">
                                                <div class="text-textPrimary"
                                                    style="font-size:0.6rem;font-weight:500;">Lab Makeup Class — Fri
                                                </div>
                                                <div class="text-muted" style="font-size:0.55rem;">Yesterday · Lab
                                                </div>
                                            </div>
                                            <div class="bg-input rounded-lg p-1.5">
                                                <div class="text-textPrimary"
                                                    style="font-size:0.6rem;font-weight:500;">Assignment 3 Deadline
                                                    Ext.</div>
                                                <div class="text-muted" style="font-size:0.55rem;">2 days ago ·
                                                    Assignment</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        <!-- Assignment -->
                                        <div class="bg-card border border-border rounded-xl p-2.5">
                                            <div class="text-textPrimary font-semibold mb-1.5"
                                                style="font-size:0.65rem;"><i
                                                    class="fas fa-tasks text-amber mr-1"></i>Upcoming</div>
                                            <div class="space-y-1">
                                                <div class="flex items-center justify-between">
                                                    <span class="text-textSecondary" style="font-size:0.6rem;">DS
                                                        Assignment #3</span>
                                                    <span class="chip chip-red"
                                                        style="font-size:0.5rem;padding:2px 6px;">2d left</span>
                                                </div>
                                                <div class="progress h-1">
                                                    <div class="progress-fill bg-accent" style="width:65%;"></div>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <span class="text-textSecondary" style="font-size:0.6rem;">OOP Lab
                                                        Report</span>
                                                    <span class="chip chip-amber"
                                                        style="font-size:0.5rem;padding:2px 6px;">5d left</span>
                                                </div>
                                                <div class="progress h-1">
                                                    <div class="progress-fill bg-purple" style="width:30%;"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Poll -->
                                        <div class="bg-card border border-border rounded-xl p-2.5">
                                            <div class="text-textPrimary font-semibold mb-1.5"
                                                style="font-size:0.65rem;"><i
                                                    class="fas fa-poll text-teal mr-1"></i>Quick Poll</div>
                                            <div class="text-textSecondary mb-1.5" style="font-size:0.6rem;">Best
                                                study time?</div>
                                            <div class="space-y-1">
                                                <div>
                                                    <div class="flex justify-between mb-0.5"
                                                        style="font-size:0.55rem;">
                                                        <span class="text-textSecondary">Morning</span><span
                                                            class="text-accent">58%</span>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="flex justify-between mb-0.5"
                                                        style="font-size:0.55rem;">
                                                        <span class="text-textSecondary">Night</span><span
                                                            class="text-purple">42%</span>
                                                    </div>
                                                    <div class="progress h-1.5">
                                                        <div class="progress-fill bg-purple" style="width:42%;"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="flex justify-between px-2 -mt-5 relative z-10 pointer-events-none">
                        <div class="bg-card border border-green border-opacity-40 rounded-xl px-3 py-1.5 flex items-center gap-2 shadow-card"
                            style="margin-top:-5px;">
                            <i class="fas fa-check-circle text-green text-xs"></i>
                            <span class="text-green text-xs font-semibold">Lab Submitted</span>
                        </div>
                        <div
                            class="bg-card border border-accent border-opacity-40 rounded-xl px-3 py-1.5 flex items-center gap-2 shadow-card">
        ...
        <!-- scroll indicator -->
        <div
            class="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-muted animate-bounce">
    ...
    <section id="features" class="py-20 max-w-7xl mx-auto px-5">
        <div class="text-center mb-12 fade-up">
            ...
            <h2 class="text-3xl md:text-4xl font-bold mb-4">Everything You Need, <span style="color:#3d7fff;">In One
                    Place</span></h2>
            <p class="text-textSecondary max-w-2xl mx-auto">A complete academic toolkit built specifically for CSE-105
                students — organized, beautiful, and always up-to-date.</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="dash-card feature-card p-5 fade-up" style="animation-delay:0.05s">
                ...
                <div class="text-textSecondary text-sm leading-relaxed">Get real-time academic notices, circulars, and
                    urgent announcements from teachers.</div>
                <div class="mt-3 flex items-center gap-1 text-accent text-xs font-medium">Learn more <i
                        class="fas fa-arrow-right ml-1 text-[10px]"></i></div>
            </div>
            ...
            <div class="dash-card feature-card p-5 fade-up" style="animation-delay:0.1s">
                ...
                <div class="text-textSecondary text-sm leading-relaxed">Track deadlines, submission status, and
                    course-wise assignments in a clean dashboard.</div>
                <div class="mt-3 flex items-center gap-1 text-accent text-xs font-medium">Learn more <i
                        class="fas fa-arrow-right ml-1 text-[10px]"></i></div>
            </div>
            ...
            <div class="dash-card feature-card p-5 fade-up" style="animation-delay:0.15s">
                ...
                <div class="text-textSecondary text-sm leading-relaxed">Download, submit and manage all your lab
                    reports with version history and teacher feedback.</div>
                <div class="mt-3 flex items-center gap-1 text-accent text-xs font-medium">Learn more <i
                        class="fas fa-arrow-right ml-1 text-[10px]"></i></div>
            </div>

            <div class="dash-card feature-card p-5 fade-up" style="animation-delay:0.2s">
                <div class="icon-box bg-green-500 bg-opacity-10 text-green mb-4"><i class="fas fa-calendar-alt"></i>
                </div>
                <div class="font-semibold text-textPrimary mb-2">Exam Routine</div>
                <div class="text-textSecondary text-sm leading-relaxed">View your class routine, exam schedule and
                    never miss an important session again.</div>
                <div class="mt-3 flex items-center gap-1 text-accent text-xs font-medium">Learn more <i
                        class="fas fa-arrow-right ml-1 text-[10px]"></i></div>
            </div>
            ...
            <div class="dash-card feature-card p-5 fade-up" style="animation-delay:0.25s">
                ...
                <div class="text-textSecondary text-sm leading-relaxed">Participate in batch polls, vote on decisions,
                    and see community opinions in real time.</div>
                <div class="mt-3 flex items-center gap-1 text-accent text-xs font-medium">Learn more <i
                        class="fas fa-arrow-right ml-1 text-[10px]"></i></div>
            </div>
            ...
            <div class="dash-card feature-card p-5 fade-up" style="animation-delay:0.3s">
                ...
                <div class="text-textSecondary text-sm leading-relaxed">Access notes, slides, books, and curated study
                    materials organized by course and topic.</div>
                <div class="mt-3 flex items-center gap-1 text-accent text-xs font-medium">Learn more <i
                        class="fas fa-arrow-right ml-1 text-[10px]"></i></div>
            </div>

            <div class="dash-card feature-card p-5 fade-up" style="animation-delay:0.35s">
                <div class="icon-box bg-coral-500 bg-opacity-10 text-coral mb-4" style="color:#fb923c;"><i
                        class="fas fa-chalkboard-teacher"></i></div>
                <div class="font-semibold text-textPrimary mb-2">Teacher Directory</div>
                <div class="text-textSecondary text-sm leading-relaxed">Find contact info, office hours, and course
                    details for all your course teachers instantly.</div>
                <div class="mt-3 flex items-center gap-1 text-accent text-xs font-medium">Learn more <i
                        class="fas fa-arrow-right ml-1 text-[10px]"></i></div>
            </div>
            ...
            <div class="dash-card feature-card p-5 fade-up" style="animation-delay:0.4s">
                <div class="icon-box"
                    style="background:rgba(34,211,238,0.1);color:#22d3ee;border-radius:12px;width:46px;height:46px;display:flex;align-items:center;justify-content:center;font-size:1.1rem;margin-bottom:1rem;">
                    <i class="fas fa-users"></i>
                </div>
                <div class="font-semibold text-textPrimary mb-2">Classmate Network</div>
                <div class="text-textSecondary text-sm leading-relaxed">Connect with your batch, find study partners,
                    and collaborate on group projects seamlessly.</div>
                <div class="mt-3 flex items-center gap-1 text-accent text-xs font-medium">Learn more <i
                        class="fas fa-arrow-right ml-1 text-[10px]"></i></div>
            </div>
        </div>
    ...
    <section id="preview" class="py-20 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-5">
            <div class="text-center mb-12 fade-up">
                ...
                <h2 class="text-3xl md:text-4xl font-bold mb-4">A Dashboard Built for <span
                        style="color:#3d7fff;">Students</span></h2>
                <p class="text-textSecondary max-w-xl mx-auto">Clean, fast, and always relevant — see exactly how your
                    academic life looks inside the hub.</p>
            </div>

            <!-- Big mock dashboard -->
            <div class="dash-card p-0 overflow-hidden fade-up"
                style="border-radius:20px;max-width:860px;margin:0 auto;">
                <!-- Topbar -->
                <div class="mock-topbar">
                    <div class="flex items-center gap-2">
                ...
                <div class="flex">
                    ...
                    <div class="mock-sidebar w-40 p-3 flex-shrink-0 hidden md:block" style="min-height:460px;">
                        <div class="flex items-center gap-1.5 mb-4 px-1">
                            <div
                                class="w-6 h-6 rounded-lg bg-accent flex items-center justify-center text-white text-[9px] font-bold">
                                <i class="fas fa-graduation-cap"></i>
                            </div>
                            <span class="text-textPrimary text-xs font-bold">CSE-105</span>
                        </div>
                        <div class="text-muted text-[9px] font-semibold uppercase tracking-wider mb-1.5 px-2">
                            Navigation</div>
                        <div class="sidebar-item active"><i
                                class="fas fa-th-large text-[10px]"></i><span>Dashboard</span></div>
                        <div class="sidebar-item"><i class="fas fa-bullhorn text-[10px]"></i><span>Notices</span><span
                                class="ml-auto bg-red text-white text-[8px] font-bold rounded-full w-4 h-4 flex items-center justify-center">3</span>
                        </div>
                        <div class="sidebar-item"><i class="fas fa-tasks text-[10px]"></i><span>Assignments</span>
                        </div>
                        <div class="sidebar-item"><i class="fas fa-flask text-[10px]"></i><span>Lab Reports</span>
                        </div>
                        <div class="sidebar-item"><i class="fas fa-calendar text-[10px]"></i><span>Routine</span>
                        </div>
                        ...
                        <div class="sidebar-item"><i class="fas fa-users text-[10px]"></i><span>Classmates</span>
                        </div>
                        <div class="mt-3 pt-3 border-t border-border">
                            <div class="sidebar-item"><i class="fas fa-cog text-[10px]"></i><span>Settings</span>
                            </div>
                            <div class="sidebar-item"><i
                                    class="fas fa-sign-out-alt text-[10px]"></i><span>Logout</span></div>
                        </div>
                    </div>
                    ...
                    <div class="flex-1 p-4 bg-bg">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div class="stat-badge text-xs"><i
                                        class="fas fa-sync-alt text-accent text-[10px]"></i><span
                                        class="text-textSecondary text-[10px]">Updated</span></div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div class="bg-card border border-border rounded-xl p-3">
                                <div class="flex items-center justify-between mb-2.5">
                                    <span class="text-textPrimary font-semibold text-xs"><i
                                            class="fas fa-bullhorn text-accent mr-1.5"></i>Recent Notices</span>
                                    <span class="text-accent text-[10px] cursor-pointer">View all →</span>
                                </div>
                                <div class="space-y-2">
                                    <div class="bg-input rounded-xl p-2.5 flex items-start gap-2">
                                        <div
                                            class="w-6 h-6 rounded-lg bg-blue-500 bg-opacity-20 flex items-center justify-center text-accent text-[9px] flex-shrink-0 mt-0.5">
                                            <i class="fas fa-info"></i>
                                        </div>
                                        <div>
                                            <div class="text-textPrimary text-[11px] font-medium leading-tight">Midterm
                                                Exam Timetable Published</div>
                                            <div class="text-muted text-[9px] mt-0.5">Dr. Ahmed · 2h ago</div>
                                        </div>
                                        <span class="chip chip-blue ml-auto flex-shrink-0"
                                            style="font-size:0.5rem;">New</span>
                                    </div>
                                    <div class="bg-input rounded-xl p-2.5 flex items-start gap-2">
                                        <div
                                            class="w-6 h-6 rounded-lg bg-green-500 bg-opacity-20 flex items-center justify-center text-green text-[9px] flex-shrink-0 mt-0.5">
                                            <i class="fas fa-flask"></i>
                                        </div>
                                        <div>
                                            <div class="text-textPrimary text-[11px] font-medium leading-tight">Lab
                                                Makeup Class — Friday 2PM</div>
                                            <div class="text-muted text-[9px] mt-0.5">Lab Dept · Yesterday</div>
                                        </div>
                                    </div>
                                    <div class="bg-input rounded-xl p-2.5 flex items-start gap-2">
                                        <div
                                            class="w-6 h-6 rounded-lg bg-amber-500 bg-opacity-20 flex items-center justify-center text-amber text-[9px] flex-shrink-0 mt-0.5">
                                            <i class="fas fa-clock"></i>
                                        </div>
                                        <div>
                                            <div class="text-textPrimary text-[11px] font-medium leading-tight">
                                                Assignment 3 Deadline Extended</div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="bg-card border border-border rounded-xl p-3">
                                    <div class="flex items-center justify-between mb-2.5">
                                        <span class="text-textPrimary font-semibold text-xs"><i
                                                class="fas fa-tasks text-amber mr-1.5"></i>Assignments</span>
                                    ...
                                    <div class="space-y-2">
                                        <div>
                                            <div class="flex items-center justify-between mb-1">
                                                ...
                                                <span class="chip chip-red"
                                                    style="font-size:0.48rem;padding:2px 5px;">Due Fri</span>
                                            </div>
                                            <div class="progress h-1.5">
                                                <div class="progress-fill bg-accent" style="width:70%;"></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="flex items-center justify-between mb-1">
                                                ...
                                                <span class="chip chip-amber"
                                                    style="font-size:0.48rem;padding:2px 5px;">Due Mon</span>
                                            </div>
                                            <div class="progress h-1.5">
                                                <div class="progress-fill bg-purple" style="width:25%;"></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="flex items-center justify-between mb-1">
                                                ...
                                                <span class="chip chip-green"
                                                    style="font-size:0.48rem;padding:2px 5px;">Submitted</span>
                                            </div>
                                            <div class="progress h-1.5">
                                ...
                                <!-- Poll widget -->
                                <div class="bg-card border border-border rounded-xl p-3">
                                    <div class="text-textPrimary font-semibold text-xs mb-2"><i
                                            class="fas fa-poll text-teal mr-1.5"></i>Active Poll</div>
                                    <div class="text-textSecondary text-[10px] mb-2 leading-snug">When should we
                                        schedule the group study session?</div>
                                    <div class="space-y-1.5">
                                        <div>
                                            <div class="flex justify-between mb-0.5">
                                            ...
                                            <div class="progress h-2">
                                                <div class="progress-fill bg-accent" style="width:62%;"></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="flex justify-between mb-0.5">
                                            ...
                                            <div class="progress h-2">
                                                <div class="progress-fill bg-purple" style="width:38%;"></div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <section id="about" class="py-20 max-w-7xl mx-auto px-5">
        <div class="text-center mb-12 fade-up">
            ...
            <h2 class="text-3xl md:text-4xl font-bold mb-4">Built for Student <span
                    style="color:#3d7fff;">Excellence</span></h2>
            <p class="text-textSecondary max-w-xl mx-auto">We designed every feature with real student pain points in
                mind — less chaos, more focus.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div class="dash-card p-7 text-center fade-up" style="animation-delay:0.05s">
                <div
                    class="w-14 h-14 rounded-2xl bg-accent bg-opacity-15 flex items-center justify-center text-accent text-2xl mx-auto mb-5">
                    <i class="fas fa-layer-group"></i>
                </div>
                <h3 class="font-bold text-textPrimary text-lg mb-3">Organized Academic Life</h3>
                <p class="text-textSecondary text-sm leading-relaxed">No more scattered WhatsApp groups or missed
                    deadlines. Everything is structured, tagged, and searchable in one beautiful dashboard.</p>
            ...
            <div class="dash-card p-7 text-center fade-up"
                style="animation-delay:0.15s;border-color:rgba(61,127,255,0.3);box-shadow:0 0 40px rgba(61,127,255,0.12);">
                <div class="w-14 h-14 rounded-2xl bg-accent bg-opacity-20 flex items-center justify-center text-accent text-2xl mx-auto mb-5"
                    style="box-shadow:0 0 20px rgba(61,127,255,0.3);">
                    <i class="fas fa-database"></i>
                </div>
                <h3 class="font-bold text-textPrimary text-lg mb-3">Centralized Resources</h3>
                <p class="text-textSecondary text-sm leading-relaxed">All study materials, past exams, notes, and books
                    — organized by course, semester, and teacher — available anytime, anywhere.</p>
                <div class="mt-5 flex flex-wrap gap-2 justify-center">
            ...
            <div class="dash-card p-7 text-center fade-up" style="animation-delay:0.25s">
                ...
                <p class="text-textSecondary text-sm leading-relaxed">Connect with classmates, vote on batch decisions
                    through polls, and build a stronger academic community together.</p>
                <div class="mt-5 flex flex-wrap gap-2 justify-center">
    ...
    <section class="py-20 max-w-7xl mx-auto px-5">
        <div class="text-center mb-12 fade-up">
            ...
            <h2 class="text-3xl md:text-4xl font-bold mb-4">Loved by <span style="color:#3d7fff;">Batchmates</span>
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div class="dash-card p-6 fade-up" style="animation-delay:0.05s">
                ...
                <p class="text-textSecondary text-sm leading-relaxed mb-5">"This platform completely changed how I
                    manage my studies. I used to miss assignments all the time — now I never miss a single deadline. The
                    notice system alone is worth it!"</p>
            ...
            <div class="dash-card p-6 fade-up" style="animation-delay:0.15s;border-color:rgba(61,127,255,0.25);">
                <div class="stars mb-3">★★★★★</div>
                <p class="text-textSecondary text-sm leading-relaxed mb-5">"The lab report section saved me so much
                    stress. I can see exactly what's due, when, and who submitted. The design is also stunning — feels
                    like a proper professional tool."</p>
                <div class="flex items-center gap-3">
            ...
            <div class="dash-card p-6 fade-up" style="animation-delay:0.25s">
                <div class="stars mb-3">★★★★★</div>
                <p class="text-textSecondary text-sm leading-relaxed mb-5">"Finally, a platform that actually
                    understands student needs. The poll system is genius — we used it to decide our study schedule and
                    everyone loved it. 100% recommend!"</p>
                <div class="flex items-center gap-3">
        ...
        <div class="space-y-3 fade-up">
            ...
            <div class="faq-item dash-card" id="faq1">
                <button class="faq-btn p-5 flex items-center justify-between gap-4" onclick="toggleFaq('faq1')">
                    ...
                    <i class="fas fa-chevron-down text-textSecondary text-xs flex-shrink-0 faq-icon"
                        id="faq1-icon"></i>
                </button>
                <div class="faq-body" id="faq1-body">
                    <div class="px-5 pb-5 text-textSecondary text-sm leading-relaxed">
                        Simply click "Get Started" and register with your CSE-105 batch roll number. Once verified by
                        the batch CR, you'll get full access to all features. Registration takes less than 2 minutes!
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item dash-card" id="faq2">
                <button class="faq-btn p-5 flex items-center justify-between gap-4" onclick="toggleFaq('faq2')">
                    <span class="text-textPrimary font-semibold text-sm text-left">Is the platform completely free to
                        use?</span>
                    <i class="fas fa-chevron-down text-textSecondary text-xs flex-shrink-0 faq-icon"
                        id="faq2-icon"></i>
                </button>
                <div class="faq-body" id="faq2-body">
                    <div class="px-5 pb-5 text-textSecondary text-sm leading-relaxed">
                        Yes! The CSE-105 Batch Solution Hub is 100% free for all CSE-105 batch students. There are no
                        premium tiers, no hidden fees — everything is available to every student equally.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item dash-card" id="faq3">
                <button class="faq-btn p-5 flex items-center justify-between gap-4" onclick="toggleFaq('faq3')">
                    <span class="text-textPrimary font-semibold text-sm text-left">Can teachers upload resources and
                        notices?</span>
                    <i class="fas fa-chevron-down text-textSecondary text-xs flex-shrink-0 faq-icon"
                        id="faq3-icon"></i>
                </button>
                <div class="faq-body" id="faq3-body">
                    <div class="px-5 pb-5 text-textSecondary text-sm leading-relaxed">
                        Yes! Teachers can be given special access to upload study materials, post notices, and create
                        assignments. Contact the CR to set up a teacher account with the appropriate permissions.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item dash-card" id="faq4">
                <button class="faq-btn p-5 flex items-center justify-between gap-4" onclick="toggleFaq('faq4')">
                    <span class="text-textPrimary font-semibold text-sm text-left">How do I submit assignments through
                        the hub?</span>
                    <i class="fas fa-chevron-down text-textSecondary text-xs flex-shrink-0 faq-icon"
                        id="faq4-icon"></i>
                </button>
                <div class="faq-body" id="faq4-body">
                    <div class="px-5 pb-5 text-textSecondary text-sm leading-relaxed">
                        Go to the Assignments section, find your assignment, click "Submit", and upload your file (PDF,
                        DOCX, ZIP supported). You'll receive a confirmation and can track your submission status in real
                        time.
                    </div>
                </div>
            </div>
    ...
    <section class="py-20 relative overflow-hidden">
        <div class="hero-glow"
            style="background:rgba(61,127,255,0.12);width:800px;height:500px;top:50%;left:50%;transform:translate(-50%,-50%);filter:blur(100px);">
        </div>
        <div class="max-w-3xl mx-auto px-5 text-center relative z-10 fade-up">
            <div class="dash-card p-12 md:p-16" style="border-color:rgba(61,127,255,0.2);">
                <div class="w-16 h-16 rounded-2xl bg-accent bg-opacity-20 flex items-center justify-center text-accent text-3xl mx-auto mb-6"
                    style="box-shadow:0 0 30px rgba(61,127,255,0.3);">
                    <i class="fas fa-rocket"></i>
                </div>
                <h2 class="text-3xl md:text-4xl font-bold mb-4">Ready to simplify your<br><span
                        style="color:#3d7fff;">academic life?</span></h2>
                <p class="text-textSecondary mb-8 text-base leading-relaxed max-w-lg mx-auto">Join 150+ CSE-105
                    students who are already managing their academic lives smarter. It takes 2 minutes to get started.
                </p>
                <div class="flex flex-wrap gap-3 justify-center">
                    <button class="btn-hero btn-hero-primary"><i class="fas fa-sign-in-alt mr-2"></i>Login
                        Now</button>
                    <button class="btn-hero btn-hero-outline"><i class="fas fa-user-plus mr-2"></i>Get
                        Started</button>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center gap-2.5 mb-4">
                        <div class="w-9 h-9 rounded-xl bg-accent flex items-center justify-center text-white"
                            style="box-shadow:0 4px 16px rgba(61,127,255,0.4);">
                    ...
                    <p class="text-textSecondary text-sm leading-relaxed max-w-xs mb-5">
                        The all-in-one academic platform designed to help CSE-105 students stay organized, connected,
                        and ahead of their coursework.
                    </p>
                    <!-- Social links -->
                    <div class="flex items-center gap-2">
                        <a href="#"
                            class="w-8 h-8 rounded-lg bg-input border border-border flex items-center justify-center text-textSecondary hover:text-accent hover:border-accent transition-all text-xs">
                ...
                <div>
                    ...
                    <div class="space-y-2.5">
                        <a href="#home"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">Home</a>
                        <a href="#features"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">Features</a>
                        <a href="#preview"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">Dashboard
                            Preview</a>
                        <a href="#about"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">About</a>
                        <a href="#contact"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">FAQ</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2.5">
                        <a href="#"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">Notices</a>
                        <a href="#"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">Assignments</a>
                        <a href="#"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">Lab
                            Reports</a>
                        <a href="#"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">Routine</a>
                        <a href="#"
                            class="block text-textSecondary text-sm hover:text-accent transition-colors">Resources</a>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-3 text-textSecondary text-xs">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span class="flex items-center gap-1.5"><span
                            class="pulse-dot w-1.5 h-1.5 rounded-full bg-green inline-block"></span>All systems
                        operational</span>
                </div>
            </div>
        </div>
