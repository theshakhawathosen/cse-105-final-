    ...
    <main id="main-content">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 fade-up">
            <div>
                ...
                <h1 class="text-xl font-bold text-tp mt-4">Edit Teacher</h1>
                <p class="text-ts text-sm">Update teacher information</p>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('teachers.update', $teacher->id) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="roomNumber" value="{{ old('roomNumber', $teacher->roomNumber) }}"
