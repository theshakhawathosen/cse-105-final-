...
@section('content')
    ...
    <main id="main-content">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 fade-up">
            ...
            <div>
                ...
                <p class="text-ts text-sm">
                    Update online class information
                </p>
            </div>
        ...
        <div class="dash-card p-5 max-w-4xl mx-auto fade-up fade-up-d2">
            ...
            <form method="POST"
                action="{{ route('online-classes.update', $onlineClass->id) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            @foreach($subjects as $subject)
                                ...
                                <option
                                    value="{{ $subject->id }}"
                                    {{ old('subject_id', $onlineClass->subject_id) == $subject->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option
                                value="Zoom"
                                {{ old('platform', $onlineClass->platform) == 'Zoom' ? 'selected' : '' }}>
                            ...
                            <option
                                value="Google Meet"
                                {{ old('platform', $onlineClass->platform) == 'Google Meet' ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input
                            type="date"
                            name="date"
                            value="{{ old('date', \Carbon\Carbon::parse($onlineClass->date)->format('Y-m-d')) }}"
                            class="w-full mt-1 bg-input border border-border rounded-xl px-3 py-2 text-tp">
                    ...
                    <div>
                        ...
                        <input
                            type="time"
                            name="time"
                            value="{{ old('time', \Carbon\Carbon::parse($onlineClass->time)->format('H:i')) }}"
                            class="w-full mt-1 bg-input border border-border rounded-xl px-3 py-2 text-tp">
