    <div class=" bg-accent right-0 h-9 bg-hover border-b border-accent/20 flex items-center z-[990] overflow-hidden"
        ...
        <div class="flex items-center gap-1.5 px-3 border-r border-accent/25 h-full shrink-0 bg-accent/10">
            ...
            <span class="text-[0.7rem] font-bold text-accent uppercase tracking-widest">Notice</span>
        ...
        <div class="flex-1 overflow-hidden h-full flex items-center">
            <div class="ticker-track" id="noticeTrack">
                ...
                <span class="inline-flex items-center gap-2 text-[0.78rem] text-prim cursor-pointer hover:text-ahover">
                    <i class="fa-solid fa-circle-info text-accent text-[0.72rem]"></i>
                    Mid-term exam routine has been published. Check the Routine tab for
                    details.
                </span>
                <span class="text-hint">•</span>
                <span class="inline-flex items-center gap-2 text-[0.78rem] text-prim cursor-pointer hover:text-ahover">
                    <i class="fa-solid fa-circle-info text-accent text-[0.72rem]"></i>
                    Assignment #4 (Data Structures) submission deadline extended to 30
                    May.
                </span>
                <span class="text-hint">•</span>
                <span class="inline-flex items-center gap-2 text-[0.78rem] text-prim cursor-pointer hover:text-ahover">
                    <i class="fa-solid fa-circle-exclamation text-red text-[0.72rem]"></i>
                    New poll posted — vote on preferred lab session timing before 20
                    May.
                </span>
            </div>
        </div>
